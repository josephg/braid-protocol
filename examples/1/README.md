This first example shows how you can use this library to subscribe to a simple feed of values which change over time. This feed makes no use of versions or patches.
